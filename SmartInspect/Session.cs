	...
	public class Session
	{
			...
			bool nonPublic)
		{
			...
			if (fields.Length > 0)
			{
				...
				// Begin a new group and append the list to the inspector
				// context.
		...
		public void LogAppDomain(Level level, string title, AppDomain domain)
		{
			...
			try
			{
				...
				ctx.AppendKeyValue("Friendly Name",
					domain.FriendlyName);
				ctx.AppendKeyValue("Base Directory",
					domain.BaseDirectory);

				ctx.StartGroup("Setup");
				ctx.AppendKeyValue("Application Base", 
					setup.ApplicationBase);
				ctx.AppendKeyValue("Application Name", 
					setup.ApplicationName);
				ctx.AppendKeyValue("Cache Path", 
					setup.CachePath);
				ctx.AppendKeyValue("Configuration File", 
					setup.ConfigurationFile);
				ctx.AppendKeyValue("License File", 
					setup.LicenseFile);
				ctx.AppendKeyValue("Private Bin Path", 
			...
			{
				LogInternalError("LogAppDomain: " + e.Message);
			}
		}
		#endif
